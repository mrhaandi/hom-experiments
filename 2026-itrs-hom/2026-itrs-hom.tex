...
First, \emph{characteristic typings} capture $\beta\eta$-equality at type~$\varphi$ via intersection-type derivability.
Second, the collection of these typings into a single vector judgement then \emph{combines} into one inhabitation problem.
